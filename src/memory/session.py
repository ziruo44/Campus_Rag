...
from memory.store import ThreadStore
...
class ManagedThread:
    ...
    def max_turns(self) -> int:
        return self._document.max_turns

    @property
    def context_summary(self) -> str:
        return self._document.context_summary

    @property
    def notices(self) -> list[dict[str, Any]]:
        return deepcopy(self._document.notices)
    ...
    def complete_turn(self, turn_id: str, assistant_content: str) -> None:
        self.complete_turn_with_artifacts(turn_id, assistant_content)

    def complete_turn_with_artifacts(
        self,
        turn_id: str,
        ...
        *,
        ...
        def updater(document: ThreadDocument) -> None:
            ...
            turn.error = None
            turn.artifacts = dict(artifacts or {})
